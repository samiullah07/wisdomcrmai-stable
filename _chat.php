...
//List the minimum requirements to have access to this bot
           ...
           <div class="chat-frame">
                ...
                function displayMessage($role, $name, $content, $dall_e_array, $datetime, $image = null, $display_avatar = false, $use_google_voice = false, $extra_class = '', $vision_img = '') {
                    ...
                    ?>
                      ...
                      <?php if($content){?>
                        <div class="conversation-thread <?php echo $role == 'assistant' ? 'thread-ai' : 'thread-user'; ?> <?php echo $extra_class; ?>">
                            ...
                            <div class="message-container">
                                <div class="message-info">
                                    ...
                                    <div class="message-text"><div class="chat-response"><?php  if($vision_img) echo "<img class='thumbnail-vision-img' src='/public_uploads/vision/".$vision_img."'>"; ?><?php echo $isImageBlock ? $content : removeCustomInput($content); ?></div></div>
                        ...
                        <!--                        <div class="wrapper-suggestion-group-">-->
                        <!---->
                        <!--                            <div class="row p-4 gx-1">-->
                        <!--                                --><?php //foreach ($getSuggestions as $i => $showSuggestions) : ?>
                        <!--                                --><?// if ($i < 4) : ?>
                        <!--                                    <div class="col-6 use-suggestion-short mb-1">-->
             ...
             <div class="message-area-bottom">
                ...
                <div class="chat-input">
                  ...
                  <img src="<?php echo $base_url; ?>/img/micro.png" id="microphone-button">
                  <?php } ?>
                  <button class="submit btn-send-chat btn" tabindex="0"><span><?php echo $lang['']; ?></span> <img  src="<?php echo $base_url; ?>/img/send.png" style="width:30px;"></button>
...
<?php if ($AI->slug == 'bark-tutor') { ?>
    ...
    <script>
        var chatPal = new ChatPal({embedId: 'xUN7uQSSkzFp', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>

<?php } ?>

<?php if ($AI->slug == 'maven') { ?>

    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'D7PKnTtBsCr3', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>

<?php } ?>
<?php if ($AI->slug == 'ellie') { ?>

    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'bhNLbm9Cxxk6', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>

<?php } ?>

<?php if ($AI->slug == 'rolly') { ?>

    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'yVXLtXz2hzM4', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>

<?php } ?>

<?php if ($AI->slug == 'techy-the-coder') { ?>

    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'Zdzty3VvgtGg', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>

<?php } ?>

<?php if ($AI->slug == 'claire') { ?>

    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'sqHqZaZjmfWd', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>

<?php } ?>

<?php if ($AI->slug == 'mr-discovery') { ?>

    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'SPpWT85SAstF', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>
...
<?php if ($AI->slug == 'neko') { ?>
    ...
    <script type="text/javascript" src="https://chatterpal.me/build/js/chatpal.js?8.3" integrity="sha384-+YIWcPZjPZYuhrEm13vJJg76TIO/g7y5B14VE35zhQdrojfD9dPemo7q6vnH44FR" crossorigin="anonymous" data-cfasync="false"></script>
    <script>
        var chatPal = new ChatPal({embedId: 'MpXN6Z2f5aXy', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
    </script>
