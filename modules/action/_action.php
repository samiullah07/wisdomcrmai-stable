...
if (isset($_REQUEST['login_id'])) {
    $getCustomer = $customers->get($_REQUEST['login_id']);
    if($getCustomer){
        ...
        redirect("/panel/students", "User not found", "error");
    }
}
...
if (isset($_POST['action'])) {
    ...
    if ($_POST['action'] == "create-account") {
      ...
      $_SESSION['form_education'] = $_POST['education'];
      ...
      $_SESSION['form_school'] = $_POST['school'];
      ...
      if($customers->add()){
        ...
        if ($config->customer_confirm_email) {
          ...
          $api_data = [
              ...
              'email' => $checkUserData->email,
              'student_phone' => $checkUserData->phone,
              'phone' => $checkUserData->phone,
              'country' => $checkUserData->country,
              'sponsor' => 'null',
              'school' => $checkUserData->school,
              'district' => 'null',
              'title' => 'AI chat '.$checkUserData->title.' school Leads'
          ];
