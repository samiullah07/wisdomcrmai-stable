      ...
      <div class="col-lg-9">
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="nav-vision" role="tabpanel" aria-labelledby="nav-vision-tab" tabindex="0">
            <fieldset class="border rounded-2 p-3 mb-4">
              <legend><h5><i class="bi bi-card-image"></i> Vision Configs</h5></legend>
              <p>To determine whether the chat will allow image uploads with Vision, configure this setting individually for each prompt.</p>
              <div class="row align-middle">


                <div class="col-md-12">
                  <div class="form-floating mb-3">
                    <input name="vision_spend_credits" type="number" class="form-control" id="floatingVisionSpent" placeholder="Amount of credits to be spent to read the image using Vision" value="<?php echo $get->vision_spend_credits; ?>" required>
                    <label for="floatingVisionSpent">Amount of credits to be spent to read the image using Vision</label>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-check form-switch mb-3 custom-switch">
                    ...
                    <small>(Be careful, only check this option if your Browser Agente never changes.)</small>
                ...
                <div class="col-md-12">
                  <div class="form-check form-switch mb-3 custom-switch">
                    ...
                    <small>(Be careful, only check this option if your IP never changes.)</small>
