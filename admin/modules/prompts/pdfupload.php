...
<?php } ?>
    ...
    <fieldset class="border rounded-2 p-3 mb-4">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-6">
                    <h2 class="text-center mb-4">Upload PDF File</h2>
                    <!-- PDF Upload Form -->

                        <div class="form-group">
                            <label for="pdfFile">Select PDF file:</label>
                            <input type="file" class="form-control-file" id="pdfFile" name="pdf_prompt" accept=".pdf" required>
                        </div>
