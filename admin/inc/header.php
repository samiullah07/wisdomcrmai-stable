...
<!--            --><?php //if (in_array("prompts", json_decode($getUser->permission) ?? [])) { ?>
<!--          <li class="nav-item">-->
<!--            <a class="nav-link --><?php //if($module_name == "pdf_prompts") echo "active";?><!--" aria-current="pdf_prompts" href="--><?php //echo $base_url; ?><!--/admin/pdf_prompts">-->
<!--              <i class="bi bi-cpu fs-5"></i>-->
<!--              PDF Prompts (AI)-->
<!--            </a>-->
<!--          </li>-->
<!--          --><?php //} ?>
          ...
          <?php if(in_array("other_users", json_decode($getUser->permission) ?? [])){?>
          <li class="nav-item">
            <a class="nav-link <?php if($module_name == "other_users") echo "active";?>" aria-current="Others" href="<?php echo $base_url; ?>/admin/others">
             <i class="bi bi-people fs-5"></i>
              Other Users
            </a>
          </li>
