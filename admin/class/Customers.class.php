...
class Customers extends Action{
    ...
    public function getList() {
        ...
        WHERE customers.role = 'student'  -- Added WHERE clause
        ORDER BY 
            customers.created_at DESC;
    ");
    }
    ...
    public function getListBySchool4($school) {
        $query = "
        SELECT customers.*,
        IFNULL(message_counts.total_messages, 0) AS total_messages,
        IFNULL(message_counts.total_threads, 0) AS total_threads,
        ...
        WHERE customers.role = 'student' 
        AND customers.school = :school  -- Added parameter binding
        ORDER BY 
            customers.created_at DESC;
    ";
