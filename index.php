    ...
    <div class="container section-spacing">
        <div class="row">
            ...
            <div class="col text-center">
                ...
                <iframe width="100%" height="500" src="https://www.youtube.com/embed/MPNrsIw_U2g?si=YvOc03hCJ_9VgK_X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<script>
    var chatPal = new ChatPal({embedId: 'vdSFMU394A6V', remoteBaseUrl: 'https://chatterpal.me/', version: '8.3'});
</script>

<script src="https://cdn.signly.co/release/latest/signly-dynamic-american.umd.min.js"></script>
